           ...
           <div class="mb-2">
             <div class="card" style="background: black;">
                ...
                <div class="card-footer">
                  <button class="btn btn-primary btn-show-movie" style="background: gray; color: ghostwhite; border: none;" data-toggle="modal" data-target="#movie-modal" data-id="${movie.id}">More
                  </button>
                  <button class="btn btn-info btn-add-favorite" style="background: gray; color: ghostwhite; border: none;" data-toggle="modal" data-id='${movie.id}'>+</button>
                </div>
              </div>
            </div>
        </div>
...
function renderPagination(amount) {
  ...
  for (let page = 1; page <= num; page++) {
    rawHTML += `
    <li class="page-item"><a class="page-link" style=" background-color: black; border-color: gold; color: gold;" href="#" data-page="${page}">${page}</a></li>
    `
  }
